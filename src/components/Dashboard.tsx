...
const Dashboard = () => {
  ...
  const { mutate: deleteFile } = trpc.deleteFile.useMutation({
    ...
    onSettled: () => {
      setCurDelFile(null); // finally
    },
  });

  return (
    <main className="mx-auto max-w-7xl md:p-10">
      <div className="flex flex-col text-center justify-between gap-4 border-b border-gray-200 p-5 sm:flex-row sm:items-center sm:gap-0">
